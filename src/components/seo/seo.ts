...
export const articleSchema = z.object({
  ...
  publisher: z
    ...
    .optional(),
  authors: z.array(z.url()).optional(),
    ...
    .array(
      z.object({
        ...
        track: z
          ...
          .optional(),
        musicians: z.array(z.url()).optional()
      })
    )
    .optional(),
  releaseDate: z.date().or(z.string()).optional()
...
export const videoMovieSchema = z.object({
  actors: z
    ...
    .optional(),
  directors: z.array(z.url()).optional(),
  duration: z
    .number()
    .refine((d) => d > 0, {
